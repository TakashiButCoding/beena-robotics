<template>
  <div class="relative w-full overflow-hidden h-[200px] lg:h-[800px] max-w-screen-desktop mx-auto">
    ...
    <button @click="prev" class="absolute top-1/2 left-0 transform -translate-y-1/2 bg-slate-700 rounded-full  text-white mx-2">
       <Icon icon="line-md:chevron-small-left" class="md:w-12 md:h-12 w-8 h-8"  style="color: #fff" />
    </button>
